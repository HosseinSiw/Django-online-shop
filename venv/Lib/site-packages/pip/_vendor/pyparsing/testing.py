...
class pyparsing_test:
    """
    namespace class for classes useful in writing unit tests-dir
    """

    class reset_pyparsing_context:
        """
        Context manager to be used when writing unit tests-dir that modify pyparsing config values:
        - packrat parsing
